...
> Lightweight registry. Agents load this first, then open only the file needed for their phase.
> Full docs: `docs/brainstorms/`, `docs/plans/`, `docs/plan-reviews/`, `docs/reviews/`
...
_Items added automatically when a phase completes. Agent picks up first `[ ]` item._
...
<!-- compound-plan-review → adds: work pending (if READY) or revise pending (if NEEDS REVISION) -->
<!-- compound-work → adds: code-review pending -->
<!-- compound-review → adds: compound pending -->
<!-- compound-compound → adds: result-log pending -->
...
**Archived tasks:** see `tasks/history/`
