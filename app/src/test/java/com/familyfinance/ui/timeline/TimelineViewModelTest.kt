...
class TimelineViewModelTest {
    ...
    fun `split grouping identifies root and children`() = runTest {
        ...
        val trans = listOf(
            Transaction(id = 2, date = septDate, amountCents = 500, accountId = 1, categoryId = 1, projectId = null, note = "Child", type = TransactionType.EXPENSE, currencyCode = "USD", receiptGroupId = groupId),
            Transaction(id = 1, date = septDate, amountCents = 1000, accountId = 1, categoryId = 1, projectId = null, note = "Root", type = TransactionType.EXPENSE, currencyCode = "USD", receiptGroupId = groupId)
        )
