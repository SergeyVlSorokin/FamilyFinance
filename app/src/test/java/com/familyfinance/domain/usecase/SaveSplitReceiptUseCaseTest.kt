...
class SaveSplitReceiptUseCaseTest {
    ...
    fun `generate receipt group id and save splits`() = runBlocking {
        ...
        assertTrue(repository.savedTransactions[0].note.contains("Split:"))
    }
    ...
    private class FakeFinanceRepository : FinanceRepository {
        ...
        override suspend fun isAccountKeyTaken(name: String, currency: String, ownerLabel: String?): Boolean = false
